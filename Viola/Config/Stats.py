...
class Stats:
    ...
    def _getResponse(self):
        self._response = requests.get(f'https://api.hypixel.net/player?key=6841122f-a0ac-4db9-88ec-52a5e0b36f13&uuid={self.uuid}').json()
    def _getFriends(self):
        self._friends = requests.get(f'https://api.hypixel.net/friends?key=6841122f-a0ac-4db9-88ec-52a5e0b36f13&uuid={self.uuid}').json()
    def _getGuild(self):
        self._guild = requests.get(f'https://api.hypixel.net/guild?key=6841122f-a0ac-4db9-88ec-52a5e0b36f13&player={self.uuid}').json()
    def SetInfo(self):
    ...
    def FormImage(self):
        ...
        font = ImageFont.truetype(os.path.join(os.path.dirname(os.path.realpath(__file__)), 'assets', 'shrift.ttf'), size=75)
        font2 = ImageFont.truetype(os.path.join(os.path.dirname(os.path.realpath(__file__)), 'assets', 'shrift.ttf'), size=60)
        font3 = ImageFont.truetype(os.path.join(os.path.dirname(os.path.realpath(__file__)), 'assets', 'shrift.ttf'), size=45)
        mainfont = ImageFont.truetype(os.path.join(os.path.dirname(os.path.realpath(__file__)), 'assets', 'main.ttf'), size=35)
