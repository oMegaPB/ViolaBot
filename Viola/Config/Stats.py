...
class Stats:
    ...
    def FormImage(self):
        ...
        font = ImageFont.truetype('app/Config/assets/shrift.ttf', size=75)
        font2 = ImageFont.truetype(r'app/Config/assets/shrift.ttf', size=60)
        font3 = ImageFont.truetype(r'app/Config/assets/shrift.ttf', size=45)
        mainfont = ImageFont.truetype(r'app/Config/assets/main.ttf', size=35)
